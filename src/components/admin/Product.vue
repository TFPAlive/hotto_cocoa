<script setup lang="ts">
	...
	const form = ref < { name: string; description?: string; price: number; material?: string; keyword?: string; category?: string; imageurl?: string; file?: File } > ({ name: '', price: 0, description: '', material: '', keyword: '', category: '', imageurl: '', file: undefined })
    ...
    function openDrawerForEdit(product: Product) {
        ...
        form.value = { name: product.name, price: product.price, description: product.description, material: product.material, keyword: product.keyword, category: cat, imageurl: product.imageurl, file: undefined }
