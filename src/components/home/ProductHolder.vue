        ...
        <div v-for="(section, idx) in sections" :key="section.title" class="product-section">
            ...
            <div class="products-row-wrapper">
                <div class="products-row-bg">
                    <button class="scroll-btn left" @click="scrollLeft(idx)" :disabled="scrollIndexes[idx] === 0"> &#8592; </button>
                </div>
            ...
            width: `${(productCount / visibleCount) * 100}%`,
                ...
                <div class="products-row-bg">
                    <button class="scroll-btn right" @click="scrollRight(idx)" :disabled="scrollIndexes[idx] === productCount - visibleCount"> &#8594; </button>
                </div>
            </div>
        </div>
    </div>
